...
> **Update, March 30, 2026:** I no longer recommend RTK (Rust Token Killer), which features heavily in this post. The hook patterns described here still apply regardless of what command proxy you use. See [What's in My CLAUDE.md in Early 2026](/en/whats-in-my-claude-md/) for details and what replaced it.
