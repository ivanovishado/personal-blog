...
heroImageAlt: "Ilustración abstracta de fragmentos de código fluyendo a través de tres puertas geométricas, volviéndose más ordenados después de cada checkpoint"
...
> **Actualización, 30 de marzo de 2026:** Ya no recomiendo RTK (Rust Token Killer), que aparece mucho en este post. Los patrones de hooks descritos aquí siguen aplicando sin importar qué proxy de comandos uses. Ve [Qué Hay en Mi CLAUDE.md a Principios de 2026](/es/whats-in-my-claude-md/) para los detalles y qué lo reemplazó.
